...
def print_dashboard(assets: dict):
    print("Coin | Initial Coin Amount | Current Coin Amount | Latest Buy Coin Amount | Buy Price | Invested Amount | Current USD Amount | Latest Sell USD Amount | Sell Price | Net Profit | Latest Action | Latest Transaction Date")
